                        ...
                        <div class="span12">
                            ...
                            <form action="#" id="form_sample_1" class="form-horizontal" style="width:70%;margin:0 auto;">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="name" id="txt-ma-sp" type="text" class="span6 m-wrap" style="width:500px !important;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="txt-ten-sp" name="name" type="text" class="span6 m-wrap" style="width:500px !important;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="txt-gia-sp" name="name" type="text" class="span6 m-wrap" style="width:500px !important;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="txt-khuyen-mai" name="name" type="text" class="span6 m-wrap" style="width:500px !important;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="txt-xuat-xu" name="name" type="text" class="span6 m-wrap" style="width:500px !important;" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea id="txt-mo-ta" name="name" type="text" class="span6 m-wrap" style="width:500px !important;"></textarea>
                                ...
                                <div style="text-align:center;">
                                    <button id="btn-them" type="submit" class="btn btn-primary">Thêm sản phẩm</button>
