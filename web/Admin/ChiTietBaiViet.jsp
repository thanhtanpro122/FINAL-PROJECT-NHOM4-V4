                        ...
                        <div class="span12">
                            ...
                            <form action="#" id="form_sample_1" class="form-horizontal" style="width:100%;margin:0 auto;">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input disabled id="txt-ma-bai-viet" type="text" name="name" data-required="1" class="span6 m-wrap" style="width:96% !important;" value="bv01" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input disabled id="txt-tieu-de" name="email" type="text" class="span6 m-wrap" style="width:96% !important;" value="Mách bạn công thức tôm sú rim cay xé lưỡi độc đáo và thử thách các tín đồ của món cay" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls" style="margin-top: -25px;">
                                        <div class="block-content collapse in">
                                            <textarea disabled id="bootstrap-editor" placeholder="Enter text ..." style="width:670px;height:500px;">Nếu bạn là tín đồ của các món cay thì chắc chắn với các công thức có vị cay không thể nảo làm khó được vị giác của bạn. Nếu như nhiều người khi nhắc đến các món cay thường nhắc đến khô gà xé cay hay mực rim cay thì hôm nay chúng tôi xin gửi đến cho bạn một công thức vô cùng tuyệt vời với tôm sú. Đó là công thức tôm sú rim cay xé lưỡi.
